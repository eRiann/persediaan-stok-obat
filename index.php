...
<html>
  <head>
    ...
    <meta name="description" content="Sistem Inventaris">
    <meta name="author" content="FebrianN" />

    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/icon_web.png" />
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo_dinas.png" alt="Logo" height="50"><br> 
        <b>Sistem Inventaris Barang Pakai Habis</b><br>
        <b>Dinas Ketahanan Pangan dan Pertanian Kota Madiun</b>
      </div><!-- /.login-logo -->
      <?php  
