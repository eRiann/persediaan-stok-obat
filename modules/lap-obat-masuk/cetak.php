...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_obat,a.jumlah_masuk,b.kode_obat,b.nama_obat,b.jenis,b.satuan,b.harga_beli
...
<body>
    <div id="title">
        Laporan Data Masuk Barang Pakai Habis<br>
        ...
        <table width="100%" border="0.3" cellpadding="0" cellspacing="0" align="center">
            <thead style="background:#e8ecee">
                <tr class="tr-title">
                    ...
                    <th height="40" align="center" valign="middle">JUMLAH<br> MASUK</th>
            ...
            <tbody>
                ...
                if ($count == 0) {
                    ...
                    <td width='80' height='20' align='center' valign='middle'></td>
                    <td style='padding-left:5px;' width='155' height='20' valign='middle'></td>
                    <td style='padding-right:10px;' width='100' height='20' align='right' valign='middle'></td>
                    <td style='padding-right:10px;' width='100' height='20' align='right' valign='middle'></td>
                    <td style='padding-right:10px;' width='100' height='20' align='right' valign='middle'></td>
                    <td width='80' height='20' align='center' valign='middle'></td>
                </tr>";
                ...
                // jika data tidak ada
                    ...
                    while ($data = mysqli_fetch_assoc($query)) {
                        ...
                        $jml_masuk = $data['jumlah_masuk'];
                        $harga_beli = ($data['harga_beli']);
                        $total_harga = format_rupiah($harga_beli * $jml_masuk);

                        // menampilkan isi tabel dari database ke tabel di aplikasi
                        echo "  <tr>
                        <td width='30' height='20' align='center' valign='middle'>$no</td>
                        <td width='80' height='20' align='center' valign='middle'>$tanggal_masuk</td>
                        ...
                        <td width='65' height='20' align='center' valign='middle'>$jml_masuk</td>
...
<?php
$filename = "LAPORAN DATA OBAT MASUK ($tgl1) s.d. ($tgl2).pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
