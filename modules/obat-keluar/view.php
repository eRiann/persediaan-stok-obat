...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_obat_keluar&form=add" title="Keluar Data" data-toggle="tooltip">
      <i class="fa fa-plus"></i> Keluarkan
    </a>
  </h1>
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_obat,a.jumlah_keluar,b.kode_obat,b.nama_obat,b.jenis,b.satuan
