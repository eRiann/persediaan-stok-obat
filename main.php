    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/logo_dinas.png" alt="Logo" height="50"> 
          <span style="font-size:30px">SIPP</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 - <b>Dinas Ketahanan Pangan dan Pertanian Kota Madiun</b>.</strong>
      </footer>
    </div><!-- ./wrapper -->
